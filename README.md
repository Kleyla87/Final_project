...
Выявлена некоторая зависимость между расстоянием и полученными чаевыми, но также и значительное количество выбросов, также прослеживается наличие стандартных сумм чаевых, кратных 5. Корреляция между этими значения составляет 0.52
...
- images                     # Скриншоты
- Taxi_project               # Исходный код программы
- README.md
